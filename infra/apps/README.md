...
| 8 | `ml-mlflow`, `ui-orchestrator` | 6, 7 (mlflow needs its Postgres/Redis backends; orchestrator publishes to Kafka) |
| 9 | `data-runner`, `ml-trainer`, `ml-burst-detector`, `ui-gateway`, `ui-frontend`, `ingresses` | 2, 6, 8 (KEDA-scaled consumers need infra-keda + Kafka; ingresses route to Services created by earlier waves) |
